      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-16">
        <div className="flex flex-col items-center justify-center gap-8 md:gap-16">
          ...
          >
            ...
            <p className="text-xl font-medium text-foreground text-center tracking-tight p-5">A Fluxora desenvolve soluções digitais para indústrias que buscam mais controle sobre seus estoques e processos. Nossa plataforma centraliza informações, identifica materiais em falta e transforma dados em indicadores que apoiam decisões mais rápidas e estratégicas.</p>
